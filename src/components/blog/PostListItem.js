...
function PostListItem(props) {
    ...
    <div className="card-body">
        ...
        <Link to={"edit"+props.post.id+"/edit"} className="btn btn-primary float-right">Edit</Link>
        <Link to={"view"+props.post.id} className="btn btn-info float-right">View</Link>
    </div>
</div>
}
